...
@Slf4j
public class SomeRecordToCommandJobApplication {
    ...
    public static void main(String[] args) {
        SpringApplicationBuilder springApplicationBuilder = new SpringApplicationBuilder(SomeRecordToCommandJobApplication.class)
